    ...
    const personaContent = {
      'Trump': {
        'splash': <div>
                    ...
                    <p>We've built a bot trained on a library of 45's speeches and tweets.  <br/>Each Trumpspire is an original work that will leave you inspired.  <b>*Trumpspired*</b>.</p>
                  </div>,
        'about': <div>
                  <p>Trumpspired is a bot that can emulate the style of our 45th President.  
                    45 is the most prolific tweeter to occupy high office, and his spontaneous, incoherent speaking style lends well to trained Markov models 
                    (more on this in the Markov Model link).</p>                        
      ...
      'Brexit': {
        'splash': <div>
                    ...
                    <p>We've built a bot trained on the twitter streams of Boris Johnson and Nigel Farage, the two most visible champions of the Leave initiative.
                      Each Brexit is an original work that will leave you inspired.  <b>*BrexitSpired</b></p>
                  </div>,
        'about': <div>
                    <p>Brexitspired is a bot that emulates the tweet style of the twin champions of the Brexit movement.
                      Each Brexitspire created by the bot is a new creative work generated by the trained model, and <b>are not actual phrases / tweets.</b>
                      We frame each saying with relevant images in the manner of inspirational posters from the 1990s.</p>
                  </div>,
        'follow': <a href="http://twitter.com/brexispired">Follow @Brexitspired</a> 
      }
    }
